...
interface CollapsibleSectionProps {
   ...
   * inside it is collapsed. The count is a total, and a nested
 ...
 * too rather than being left as a fourth divergent copy (CLAUDE.md * this codebase has a repeated history of two copies of one idea drifting).
 */
