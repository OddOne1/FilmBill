 ...
 *
 * shared the moment it was needed twice (forced enrolment on the
 * login screen, and enrolling or regenerating from settings) rather than
 * copied. This codebase has paid for the other choice: FreeFrame carried the
 * same file-size logic in four places, and the same login-response
