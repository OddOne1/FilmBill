/**
 * The login screen under two-factor authentication.
 *
 ...
 * case FreeFrame designed for, and the easiest one to lose), backup codes are
 * shown and gate the redirect, and magic-code sign-in is not offered on an
 * instance whose API refuses it.
 */
...
describe('the 2fa-code step', () => {
  ...
  it('challenges an enrolled user even when the instance does NOT require 2FA', async () => {
    // The case FreeFrame built enforcement-off around: turning the site-wide
