/**
 * The session that changes its own 2FA keeps working.
 *
 ...
 * than the behaviour FreeFrame §199 exists to fix, not better.
 *
 ...
 * FreeFrame §196 had to fix on the login screen.
 */
...
describe('nothing is stored when there is nothing to store', () => {
  it('a null tokens field leaves the existing session alone', async () => {
    // An API that has not deployed FreeFrame §199 yet. Keeping the tokens we have is
