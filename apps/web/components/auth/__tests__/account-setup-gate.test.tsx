/**
 * The onboarding gate, client side.
 *
...
describe('the gate screen', () => {
  ...
  it('has no way to dismiss or skip it', () => {
    ...
    // would have to be stored as a flag — and a flag is exactly what FreeFrame §200
  ...
  it('adopts the replacement tokens and re-reads /auth/me after setting one', async () => {
    ...
    // setting a password bumps token_version and ends this tab's own
