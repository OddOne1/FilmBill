/**
 * Self-service two-factor, in profile settings.
 *
 ...
 * account will answer to next — and FreeFrame built a gate for it that a
...
describe('an account that is already enrolled', () => {
  ...
  it('demands the current factor before starting a REPLACEMENT enrolment', async () => {
    const user = userEvent.setup()
    ...
    // the description now names the user's ACTUAL factor rather than
