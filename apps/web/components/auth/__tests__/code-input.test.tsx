/**
 * The six-digit code boxes: behaviour, pinned before a layout change.
 *
 * FreeFrame §201 regrouped these boxes — centred as one tight cluster with the usual
 ...
 * FreeFrame §201 layout change verified rather than merely reasoned about, and they are
...
describe('typing', () => {
  it('advances across the 123 456 break', async () => {
    // Box 4 is where FreeFrame §201 put the wider gap. If that gap had been drawn by
