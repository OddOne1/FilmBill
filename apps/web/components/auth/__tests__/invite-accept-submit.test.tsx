/**
 * Accepting an invite: the submit button works, and never dies silently.
 *
 ...
 * assume the very thing that was broken, and the whole lesson of FreeFrame §202 is that
...
describe('when scoring is unavailable', () => {
  it('still lets a policy-satisfying password be submitted', async () => {
    // FreeFrame §202's real lesson. Even with the meter dead, the form must work: the
