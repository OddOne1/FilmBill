/**
 * Types for the zxcvbn language packs reached by their ESM path.
 *
 ...
 * the CJS build under vitest, and the CJS build is what made the FreeFrame §202 bug
 ...
 * absence is the whole subject of FreeFrame §202. Writing `default: unknown` here would
