 ...
 * mirroring the relationships already present in the base
...
// The base palette, matching app/globals.css -- the
...
/**
 * The accent a viewer actually sees when nothing overrides it.
 *
