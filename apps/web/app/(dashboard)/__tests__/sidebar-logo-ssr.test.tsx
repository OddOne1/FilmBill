/**
 * The sidebar's logo is right on the FIRST paint.
 *
 ...
 * has no data and paints the bundled FilmBill icon, which swaps to the
...
describe('a fresh install', () => {
  it('still shows the bundled FilmBill default', async () => {
