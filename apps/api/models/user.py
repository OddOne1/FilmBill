...
from sqlalchemy import String, Enum, DateTime, JSON, Boolean, Integer, func
...
class User(Base):
    ...
    #:
    #: renamed from `totp_enabled`. Once email can be the PRIMARY
...
def gate_outstanding(user: User) -> bool:
    """Whether this user should be blocked out of the app.
