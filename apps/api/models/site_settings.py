...
class SiteSettings(Base):
    ...
    org_name: Mapped[str] = mapped_column(String, nullable=False, server_default="FilmBill")
    ...
    #: the daily maintenance jobs. "UTC" is the default because FilmBill is
    #: self-hostable and this deployment's own timezone is not a sensible
    #: default for anyone else's.
    #:
