"""TOTP secrets, provisioning URIs, and encryption at rest.
...
def totp_provisioning_uri(secret: str, email: str, issuer: str = "FilmBill") -> str:
    ...
    else should not say "FilmBill" in someone's authenticator.
    """
    return pyotp.TOTP(secret).provisioning_uri(name=email, issuer_name=issuer or "FilmBill")
