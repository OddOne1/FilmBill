...
# in. Since FreeFrame the two are not even governed by the same policy: login
...
# collision FreeFrame already refused to accept between login and 2FA codes.
#
...
def has_live_2fa_email_code(email: str) -> bool:
    """Whether an unexpired 2FA code is already outstanding.
...
def store_pending_2fa_setup(
    ...
    """Stage an enrolment that has not been confirmed yet.
