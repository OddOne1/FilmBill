"""Backup address, the onboarding-gate waiver, and the passwordless cut-off.
...
Revision ID: 0004_account_security_gate
Revises: 0003_email_smtp_security
"""
...
revision: str = "0004_account_security_gate"
down_revision: Union[str, Sequence[str], None] = "0003_email_smtp_security"
