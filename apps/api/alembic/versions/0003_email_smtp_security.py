"""Add email_settings.smtp_security — three SMTP modes, not two.
...
Revision ID: 0003_email_smtp_security
...
revision: str = "0003_email_smtp_security"
down_revision: Union[str, Sequence[str], None] = "0002_user_token_version"
