...
def update_email_settings(
    ...
    # validated AFTER the write loop above, same as mail_provider
...
def send_test_email(
    ...
    try:
        ...
        ok = service.send_email(
            ...
            "<h2>It works</h2>"
            "<p>Your FilmBill mail settings are configured correctly.</p>"
            "</body></html>",
            "Your FilmBill mail settings are configured correctly.",
        )
